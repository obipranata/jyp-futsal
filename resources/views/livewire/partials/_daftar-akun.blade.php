 ...
 <form wire:submit="register">
     ...
     <div class="py-4 space-y-4">
         ...
         <div class="space-y-2">
                ...
                <textarea id="map" wire:model="map" rows="4" class="block bg-[#F1F1F1] border-none text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full" placeholder="link embed google map..."></textarea>
