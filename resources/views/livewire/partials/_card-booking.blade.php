<div class="p-2.5 bg-white-smoke rounded-lg space-y-4 flex-1 flex flex-col min-w-[300px]">
  ...
  <div class="text-sm font-semibold pl-2">
    ...
    @endif
    @endforeach
    <div class="pl-2 flex {{$rating > 0 ? 'justify-between' : 'justify-end'}} items-center">
        @if ($rating > 0)
