                ...
                <table class="min-w-full bg-white">
                    <thead class="bg-gray-800 text-white">
                        <tr>
                            ...
                            <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Nama Lapangan</th>
                    ...
                    <tbody class="text-gray-700">
                        @foreach ($penyewaan as $item)
                            <tr>
                                ...
                                <td class="text-left py-3 px-4">{{$item->lapangan?->user?->nama ?? ''}}</td>
                                ...
                                <td class="text-left py-3 px-4">Rp.{{ number_format($item->harga_full) ?? ''}}</td>
                                <td class="text-left py-3 px-4">Rp.{{ number_format($item->harga_bayar) ?? ''}}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
