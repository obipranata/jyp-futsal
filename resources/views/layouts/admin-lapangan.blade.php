...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="{{route('admin-lapangan.index')}}" class="text-white text-lg font-semibold uppercase hover:text-gray-300">{{auth()->user()->nama}}</a>
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="{{route('admin-lapangan.laporan')}}" class="flex items-center {{Route::currentRouteName() === 'admin-lapangan.laporan' ? 'active-nav-link' : ''}} text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
                <i class="fas fa-table mr-3"></i>
                Laporan
            </a>
        </nav>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="{{route('admin-lapangan.laporan')}}" class="flex items-center {{Route::currentRouteName() === 'admin-lapangan.laporan' ? 'active-nav-link' : ''}} text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                    <i class="fas fa-table mr-3"></i>
                    Laporan
                </a>
